...
| **13b-prog** ✅ | [SOF2 progressive Huffman + P=12 — C model](spec_phase13b_prog.md) | 1d | 20/20 phase13b_prog 向量 bit-exact vs libjpeg-turbo（gray + 4:4:4 + 4:2:0 × grad/check/noise × 8×8..321×241，DRI ∈ {0,1,4,16}，q 50-90，cjpeg -precision 12 -progressive 默认 script 覆盖 4 种 scan 类型），full + phase22 + phase24 + phase24c + phase17d + phase12c 零退步（1515/1515） |
| **13b-ext** ✅ | [SOF2 + P=12 扩展 chroma (4:2:2 / 4:4:0 / 4:1:1) — C model](spec_phase13b_prog.md) | 0.5d | 36/36 phase13b_ext 向量 bit-exact vs libjpeg-turbo（3 sampling × 12 尺寸含各模式 MCU 非对齐，DRI ∈ {0,1,4,16}，q 50-90），基于 drain 统一重构的单点扩展，make regress 全量零退步（2329/2329） |
